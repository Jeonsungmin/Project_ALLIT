...
public class CartController {
	...
	//찜하기
	  ...
	  //
	  //int cate = cart.getCategory_idx();
	  
	  //logger.info("카테고리" + cate);
	  ...
	  //} else if(cate == 1) { // logger.info("일반 회원만 가능함");
...
/*
	  @RequestMapping(value = "/addcart", method = RequestMethod.GET) public String
	  addCart(CartDTO cart, HttpSession session,
