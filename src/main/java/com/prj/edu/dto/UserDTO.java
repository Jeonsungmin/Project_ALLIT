...
public class UserDTO {
   ...
   public String getMb_detail_addr() {
      return mb_detail_addr;
   }
   public void setMb_detail_addr(String mb_detail_addr) {
      this.mb_detail_addr = mb_detail_addr;
   }
