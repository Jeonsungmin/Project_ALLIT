	...
	<form action="userList" method="post">
		...
		<table style="margin-left: 200px; margin-top: -450px;">
			...
			<c:forEach items="${cartList}" var="cartList">     
				<tr>
					<td>${cartList.edu_name}</td>										
					<td><a href="recruit/detail.do?idx=${cartList.recruit_idx}">${cartList.recruit_title}</a></td>
					<td>${cartList.recruit_period_sta} ~ ${cartList.recruit_period_end}</td>
					<td>${cartList.recruit_close}</td>
					<td>${cartList.cart_date}</td>
					<td><a href="/cartDelete?cart_idx=${cartList.cart_idx}">삭제</a></td>
				</tr>
			</c:forEach>
